...
export default function Upload() {
  const [data] = useState(UpdateData.Upload);
  return (
    <div className="Upload">
      <div className="Upload_row_1">
        <h2>
          How to Upload Your Art as an <br /> NFT on NFT Nexus
        </h2>
        <p>
          Bring your artwork to life as a Non-Fungible Token on [Brand Name].{" "}
          <br /> Our platform makes it easy for artists and collectors alike to
          upload <br /> and sell their unique digital creations.{" "}
        </p>
